	...
	<div class="wrap">
		<div class="content-top" style="min-height:300px;padding:50px">
            ...
            <div class="panel-body">
              ...
              <p class="login-box-msg">Ayo Nonton Sekarang</p>
              ...
              <button class="btn btn-warning" onclick="location.href='admin/index.php';">Admin Login</button>
              <button class="btn btn-warning" onclick="location.href='theatre/index.php';">Theatre Admin Login</button>
            </div>
          </div>
		  	</div>
		  </div>
